...
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10401, NULL, 'GENERADO', DATE_SUB(NOW(), INTERVAL 35 DAY), 'Pedido antiguo');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10401, 'GENERADO', 'EN_ALMACEN', DATE_SUB(NOW(), INTERVAL 34 DAY), 'Procesado mes pasado');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10401, 'EN_ALMACEN', 'EN_RUTA', DATE_SUB(NOW(), INTERVAL 32 DAY), 'En viaje larga distancia');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10401, 'EN_RUTA', 'ENTREGADO', DATE_SUB(NOW(), INTERVAL 30 DAY), 'Entregado correctamente');
...
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10402, NULL, 'GENERADO', DATE_SUB(NOW(), INTERVAL 10 DAY), 'Reposición semanal');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10402, 'GENERADO', 'EN_ALMACEN', DATE_SUB(NOW(), INTERVAL 9 DAY), 'Control de frío');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10402, 'EN_ALMACEN', 'EN_RUTA', DATE_SUB(NOW(), INTERVAL 8 DAY), 'Salida reparto');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10402, 'EN_RUTA', 'ENTREGADO', DATE_SUB(NOW(), INTERVAL 7 DAY), 'Recibido por gerente');
...
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10403, NULL, 'GENERADO', DATE_SUB(NOW(), INTERVAL 15 DAY), 'Intento de compra');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10403, 'GENERADO', 'CANCELADO', DATE_SUB(NOW(), INTERVAL 14 DAY), 'Cancelado por falta de pago');
...
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10404, NULL, 'GENERADO', DATE_SUB(NOW(), INTERVAL 3 DAY), 'Envío express');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10404, 'GENERADO', 'EN_ALMACEN', DATE_SUB(NOW(), INTERVAL 3 DAY), 'Rápido en depósito');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10404, 'EN_ALMACEN', 'EN_RUTA', DATE_SUB(NOW(), INTERVAL 2 DAY), 'Salió a destino');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10404, 'EN_RUTA', 'DEVUELTO', DATE_SUB(NOW(), INTERVAL 1 DAY), 'Dirección no encontrada');
...
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10405, NULL, 'GENERADO', DATE_SUB(NOW(), INTERVAL 5 HOUR), 'Generado hoy temprano');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10405, 'GENERADO', 'EN_ALMACEN', DATE_SUB(NOW(), INTERVAL 4 HOUR), 'Procesado');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10405, 'EN_ALMACEN', 'EN_RUTA', DATE_SUB(NOW(), INTERVAL 1 HOUR), 'En camino ahora mismo');
...
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10406, NULL, 'GENERADO', DATE_SUB(NOW(), INTERVAL 3 DAY), 'Llegó el lunes');
INSERT INTO historial_estado_envio (envio_id, estado_anterior, estado_nuevo, fecha_hora, observacion) VALUES (10406, 'GENERADO', 'EN_ALMACEN', DATE_SUB(NOW(), INTERVAL 3 DAY), 'Esperando camión especial');
